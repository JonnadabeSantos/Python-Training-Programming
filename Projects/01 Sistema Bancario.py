...
#====================================================
    ...
    if conta_corrente:      
        ...
        while reset_operacao_conta_corrente == "inicie":
            ...
            operacao_conta_corrente = int(input(
"""
[01] Saque:
[02] Depósito:
[03] Saldo:
...
Selecione a Operação: """))       
            ...
            if operacao_conta_corrente == 1:
                ...
                saque_conta_corrente = int(input("Informe o Valor do Saque em sua conta corrente: "))
                ...
                if saque_conta_corrente > (saldo_conta_corrente + cheque_especial):
                    ...
                    while reset_sim_ou_nao == "inicie":
                        continuar_saque = input("Degite sim ou não: ")
                        continuar_saque = continuar_saque.lower()
